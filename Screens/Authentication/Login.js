  ...
  return (
    <View
      ...
      <View
        ...
        <TouchableOpacity
          style={{width: '100%', alignSelf: 'center', marginTop: 75}}
          activeOpacity={0.6}
          onPress={forgotPassword()}>
          <Text
            style={{
              alginSelf: 'center',
              color: DARK.TERTIARY_TEXT_COLOR,
        ...
        <View style={{width: '100%', alignSelf: 'center', marginTop: 30}}>
          <TouchableOpacity
            style={{
              width: 0.4 * WIDTH,
              height: 50,
              backgroundColor: DARK.PRIMARY_BUTTON,
              position: 'absolute',
              zIndex: 2,
              left: (WIDTH - 0.4 * WIDTH) / 2,
              textAlign: 'center',
              fontSize: 20,
              fontFamily: 'Biryani-SemiBold',
              paddingVertical: 0,
            ...
            <Text
              style={{
                alignSelf: 'center',
                color: DARK.PRIMARY_BUTTON_TEXT,
                fontFamily: 'Biryani-Bold',
                fontSize: 20,
                textAlign: 'center',
              }}>
        ...
        <View style={{width: '100%', alignSelf: 'center', marginTop: 10}}>
          <TouchableOpacity
            style={{
              width: 0.4 * WIDTH,
              height: 50,
              backgroundColor: DARK.TERTIARY_BUTTON,
              position: 'absolute',
              zIndex: 2,
              left: (WIDTH - 0.4 * WIDTH) / 2,
              textAlign: 'center',
            ...
            <Text
              style={{
                alginSelf: 'center',
                color: DARK.TERTIARY_BUTTON_TEXT,
                fontFamily: 'Biryani-Bold',
                fontSize: 20,
                textAlign: 'center',
              }}>
