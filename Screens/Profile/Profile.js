...
const domainName = "aakash.crypto";
const WalletData = [
...
const ProfileHeader = () => {
    return(
        ...
        <View style={{width:'100%',alignSelf:'center', justifyContent: 'center', flexDirection:'column'}}>
            ...
            <Text style={{width:'100%',height:20,fontSize:13, fontFamily:'Biryani-Bold', color:DARK.TERTIARY_TEXT_COLOR, textAlign: 'center', alignSelf:'center', marginTop:5}}>{domainName}</Text>
...
const ProfileBody = () => {
                                     ...
                                     <View style={{width:93}}>
                                         ...
                                         <View style={{width:'100%', alignSelf:'center'}}>
                                             <View style={{width:89, height:35, backgroundColor:DARK.PRIMARY_BUTTON, position:'absolute', zIndex:2, textAlign:'center', fontSize:20, fontFamily:'Biryani-SemiBold', paddingVertical:0, elevation:5, borderColor:'black', borderWidth:1, borderRadius:3, justifyContent:'center'}}>
                                                 ...
                                                 <Text style={{alginSelf:'center', color:DARK.PRIMARY_BUTTON_TEXT, fontFamily:'Biryani-Bold', fontSize:14, textAlign:'center',}}>{item.balance}  {chain}</Text>
    ...
    return(
        <View style={{width:'100%',height:HEIGHT-190, alignSelf:'center', justifyContent: 'flex-start', flexDirection:'column'}}>
          ...
          {
          (flatListOption=="wallet")?<Wallet/>:<GameAssets/>
          }
        </View>
    );
}
